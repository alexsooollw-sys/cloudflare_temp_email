...
- docs: |Upgrade| 新增 [`UPGRADE.md`](./UPGRADE.md) — 简短的 v1.x → v2.0 升级清单（~15 分钟，6 步 + verify + rollback + FAQ），针对已有部署。完整变更说明留在 `MIGRATION_v1_to_v2.md`；双语 README 在 v2.0 概览开头加入升级清单链接。
